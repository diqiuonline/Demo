...
public class SmsUtils {
	private static String userid = "diqiuonline";
	private static String pass = "abcde369";
	...
	public static void main(String[] args) throws IOException {
		...
		/*System.out.println(sendSmsByWebService("xxx", "尊敬的用户您好，本次获取的验证码为："
				+ randomCode + ",服务电话：4006184000"));*/
        String s = sendSmsByHTTP("18681955953", "尊敬的用户你好 本次获得的验证码为5901,服务电话：8008008800");
