					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li class="active"><a href="${pageContext.request.contextPath}/login/product_list.jsp">手机数码<span class="sr-only">(current)</span></a></li>
								<li><a href="#">电脑办公</a></li>
								<li><a href="#">电脑办公</a></li>
								<li><a href="#">电脑办公</a></li>
							</ul>
		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/login/products/1/cs10001.jpg">
					</div>
					...
					<div class="col-md-6">
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<div style="margin:20px 0 10px 0;;text-align: center;">
								<a href="${pageContext.request.contextPath}/CartServlet?name=大冬瓜">
									<input style="background: url('${pageContext.request.contextPath}/login/images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="button">
								</a> &nbsp;收藏商品</div>
						</div>
					</div>
				</div>
				...
				<div style="width:950px;margin:0 auto;">
					...
					<div>
						<img src="${pageContext.request.contextPath}/login/image/r___________renleipic_01/bigPic139f030b-d68b-41dd-be6d-b94cc568d3c5.jpg">
					</div>
