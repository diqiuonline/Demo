...
public class KafkaMessageProcessor implements Runnable {
    ...
    public KafkaMessageProcessor(KafkaStream kafkaStream) {
        ...
        this.cacheService = (CacheService) SpringContext.getApplicationContext().getBean("cacheServiceImpl");
    }
    ...
    public void run() {
        ...
        while (it.hasNext()) {
            ...
            //从这里提取出消息对应的服务的标识
            String serciceId = messageJSONObject.getString("serviceId");
            //如果是商品信息服务
            if ("productInfoService".equals(serciceId)) {
                 processProductInfoChangeMessage(messageJSONObject);
            } else if ("shopInfoService".equals(serciceId)) {
    ...
    private void processProductInfoChangeMessage(JSONObject messageJSONObject) {
        ...
        //商品信息服务 一般来说就会去查询数据库 去获取product=1的商品信息 返回回来
