...
function changeImg(){
	document.getElementById("img123").src="${pageContext.request.contextPath}/CheckImgServlet?tima="+new Date().getTime();
}
</script>
<style>
  body{
			...
			<div class="container-fluid">
				...
				<div class="col-md-3" style="padding-top:20px">
					<ol class="list-inline">
						...
						<li><a href="${pageContext.request.contextPath}ClearServletLogin">购物车</a></li>
					</ol>
				</div>
			</div>
			<!--
...
<div class="container"  style="width:100%;height:460px;background:#FF2C4C url('${pageContext.request.contextPath}/login/images/loginbg.jpg') no-repeat;">
<div class="row"> 
	<div class="col-md-7">
		<!--<img src="${pageContext.request.contextPath}/login/login.jpg" width="500" height="330" alt="会员登录" title="会员登录">-->
	</div>
...
<form class="form-horizontal" action="${pageContext.request.contextPath}/LoginServlet" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <img id = "img123"  src="${pageContext.request.contextPath}/CheckImgServlet" onclick="changeImg()"/>
    </div>
  ...
  <div class="form-group">
    ...
    style="background: url('${pageContext.request.contextPath}/login/images/login.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
	...
	<div style="margin-top:50px;">
			<img src="${pageContext.request.contextPath}/login/img/footer.jpg" width="100%" height="78" alt="我们的优势" title="我们的优势" />
		</div>
