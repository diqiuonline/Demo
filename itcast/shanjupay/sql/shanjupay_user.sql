...
-- Records of account
-- ----------------------------
INSERT INTO `account` VALUES (1, 'test01', '18681955954', 'b87988fe5281488b369d2b09ab551f17', '2Tg20');
INSERT INTO `account` VALUES (2, 'test02', '18681955955', '40766cc7178c5e30afa4d7b7c7b99bf9', 'U8CLc');
INSERT INTO `account` VALUES (3, 'test03', '18681955956', 'beee9bca16760eed8ab91c82a96ba895', 'W3g36');
INSERT INTO `account` VALUES (4, 'test04', '18681955957', '2d8fbd535a6e9af6e3450f7772d7448e', 'fi75U');
INSERT INTO `account` VALUES (5, 'test110', '18681955110', '77e0593c2963973ea767b33fbb93f0ec', 'W3FWu');
INSERT INTO `account` VALUES (6, 'test199', '18683753245', '7fa6bb5e0393b2bea41cc74ff2dded83', '77M6T');
...
CREATE TABLE `account_role`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '账号-角色关系' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of account_role
-- ----------------------------
INSERT INTO `account_role` VALUES (1, 'test01', 'r_001', 2);
INSERT INTO `account_role` VALUES (2, 'test01', 'r_002', 2);
INSERT INTO `account_role` VALUES (3, 'test02', 'r_001', 4);
INSERT INTO `account_role` VALUES (4, 'test02', 'r_002', 4);
INSERT INTO `account_role` VALUES (5, 'test03', 'r_001', 6);
INSERT INTO `account_role` VALUES (6, 'test03', 'r_002', 6);
INSERT INTO `account_role` VALUES (7, 'test04', 'r_001', 7);
INSERT INTO `account_role` VALUES (8, 'test04', 'r_002', 7);
INSERT INTO `account_role` VALUES (9, 'test110', 'r_001', 8);
INSERT INTO `account_role` VALUES (10, 'test110', 'r_002', 8);
INSERT INTO `account_role` VALUES (11, 'test199', 'r_001', 9);
INSERT INTO `account_role` VALUES (12, 'test199', 'r_002', 9);
...
CREATE TABLE `authorization_privilege_group`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限组' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 62 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色信息' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `authorization_role` VALUES (52, '商户管理员', 'r_001', 4);
INSERT INTO `authorization_role` VALUES (53, '商户门店收银员', 'r_002', 4);
INSERT INTO `authorization_role` VALUES (54, '商户管理员', 'r_001', 6);
INSERT INTO `authorization_role` VALUES (55, '商户门店收银员', 'r_002', 6);
INSERT INTO `authorization_role` VALUES (56, '商户管理员', 'r_001', 7);
INSERT INTO `authorization_role` VALUES (57, '商户门店收银员', 'r_002', 7);
INSERT INTO `authorization_role` VALUES (58, '商户管理员', 'r_001', 8);
INSERT INTO `authorization_role` VALUES (59, '商户门店收银员', 'r_002', 8);
INSERT INTO `authorization_role` VALUES (60, '商户管理员', 'r_001', 9);
INSERT INTO `authorization_role` VALUES (61, '商户门店收银员', 'r_002', 9);
...
) ENGINE = InnoDB AUTO_INCREMENT = 786 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色-权限关系' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `bundle`  (
  ...
  `NUMBER_OF_INVOCATION` int(0) NOT NULL COMMENT 'API调用次数/月',
  `NUMBER_OF_CONCURRENT` int(0) NOT NULL COMMENT '并发数/秒',
  `NUMBER_OF_APP` int(0) NOT NULL COMMENT '允许创建应用数量',
  `COMMENT` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '套餐说明',
  `INITIALIZE` int(0) NULL DEFAULT NULL COMMENT '是否为初始化套餐',
  PRIMARY KEY (`ID`) USING BTREE,
...
-- ----------------------------
-- Table structure for jg_jgsx_national_standard
-- ----------------------------
DROP TABLE IF EXISTS `jg_jgsx_national_standard`;
CREATE TABLE `jg_jgsx_national_standard`  (
  `cd_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键',
  `object_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '数据类型：100：事项目录 101：实施清单',
  `object_body` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '数据对象实体',
  `version_id` varchar(14) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '版本Id',
  `version_date` datetime(0) NOT NULL COMMENT '版本日期',
  `cd_time` datetime(0) NOT NULL COMMENT '插入时间',
  `cd_source` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '来源（省|部门）',
  `cd_batch` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '批次号',
  `cd_operation` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '新增数据类型i-insert,u-update,d-delete',
  `cd_lsh` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '自增流水号',
  PRIMARY KEY (`cd_id`) USING BTREE,
  UNIQUE INDEX `cd_lsh`(`cd_lsh`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '国家平台数据下发事项表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of jg_jgsx_national_standard
-- ----------------------------
...
CREATE TABLE `resource_button`  (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1241761810982985031 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '按钮资源' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `resource_menu`  (
  ...
  `PCODE` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用于鉴权',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tenant` VALUES (2, 'test01_287Q47', 'shanju-merchant', 'shanju-merchant');
INSERT INTO `tenant` VALUES (4, 'test02_I6cshm', 'shanju-merchant', 'shanju-merchant');
INSERT INTO `tenant` VALUES (6, 'test03_Hc4TKW', 'shanju-merchant', 'shanju-merchant');
INSERT INTO `tenant` VALUES (7, 'test04_TPym3D', 'shanju-merchant', 'shanju-merchant');
INSERT INTO `tenant` VALUES (8, 'test110_FQjh0B', 'shanju-merchant', 'shanju-merchant');
INSERT INTO `tenant` VALUES (9, 'test199_z8Ieuo', 'shanju-merchant', 'shanju-merchant');
...
CREATE TABLE `tenant_account`  (
  `ID` bigint(0) NOT NULL AUTO_INCREMENT,
  `TENANT_ID` bigint(0) NULL DEFAULT NULL COMMENT '租户id',
  `ACCOUNT_ID` bigint(0) NULL DEFAULT NULL COMMENT '账号d',
...
INSERT INTO `tenant_account` VALUES (2, 4, 2, 1);
INSERT INTO `tenant_account` VALUES (3, 6, 3, 1);
INSERT INTO `tenant_account` VALUES (4, 7, 4, 1);
INSERT INTO `tenant_account` VALUES (5, 8, 5, 1);
INSERT INTO `tenant_account` VALUES (6, 9, 6, 1);
