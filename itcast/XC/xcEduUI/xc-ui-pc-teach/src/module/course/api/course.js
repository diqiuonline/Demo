...
export const updateCoursebase = (courseId,coursebase) =>{
  return http.requestPut(apiUrl + '/course/updatecourse/'+courseId,coursebase)
}
/*查询课程营销信息*/
export const getCourseMarketById = courseId => {
  return http.requestQuickGet(apiUrl + '/course/getcoursemarket/' + courseId)
}
/*更新课程营销信息*/
export const updateCourseMarket = (courseId,coursemarket) => {
  return http.requestPost(apiUrl + '/course/updaatecoursemarket/' + courseId,coursemarket)
}
