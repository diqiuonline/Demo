			...
			<div class="container-fluid">
				...
				<div class="col-md-3" style="padding-top:20px">
					<ol class="list-inline">
						...
						<li><a href="${pageContext.request.contextPath}/login/cart.htm">购物车</a></li>
					</ol>
				</div>
			</div>
			<!--
...
<div class="container" style="width:100%;background:url('${pageContext.request.contextPath}/login/image/regist_bg.jpg');">
<div class="row"> 
		...
		<form class="form-horizontal" style="margin-top:5px;" action="${pageContext.request.contextPath}/RegisterServlet" method="post">
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			    <img src="${pageContext.request.contextPath}/login/image/captcha.jhtml"/>
			    </div>
